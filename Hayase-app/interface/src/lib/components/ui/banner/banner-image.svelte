...
<style>
  :global(.banner-gr::after) {
    ...
    width: 100%;
    height: 100%;
    background: radial-gradient(75% 65% at 59.18% 34.97%, rgba(0, 0, 0, 0.16) 30.56%, #000000 100%);
  }

  :global(.banner-gr-sm::after) {
    background: radial-gradient(75% 65% at 50% 34.97%, rgba(0, 0, 0, 0.16) 30.56%, #000000 100%) !important;
  }
</style>
