...
<Button variant={isActive ? 'default' : 'ghost'} {href} on:click={handleClick} class={cn(className, 'px-2 w-10 relative md:pl-4 md:w-12 md:rounded-l-none group/sidebar duration-300 bg-transparent')} {...$$restProps}>
  {#if isActive}
